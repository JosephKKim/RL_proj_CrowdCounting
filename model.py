...
class Dueling_DQN_simpleV(nn.Module):
    def __init__(self, ACTION_NUMBER, HV_NUMBER):
        super(Dueling_DQN_simpleV, self).__init__()
        # start from feature
        self.ACTION_NUMBER = ACTION_NUMBER
        self.layer1 = nn.Conv2d(in_channels=HV_NUMBER+512, out_channels=1024, kernel_size=1, padding=0)
        self.layer1_ = nn.Conv2d(in_channels=HV_NUMBER+512, out_channels=1024, kernel_size=1, padding=0)
        self.layer2 = nn.ReLU(inplace=True)  
        self.layer2_ = nn.ReLU(inplace=True) 
        self.layer3 = nn.Conv2d(in_channels=1024, out_channels=1024, kernel_size=1, padding=0)     
        self.layer3_ = nn.Conv2d(in_channels=1024, out_channels=1024, kernel_size=1, padding=0)     
        self.layer4 = nn.ReLU(inplace=True)  
        self.layer4_ = nn.ReLU(inplace=True)        
        self.layer5 = nn.Conv2d(in_channels=1024, out_channels=ACTION_NUMBER, kernel_size=1, padding=0)    
        # layer for value
        self.layer_v = nn.Conv2d(in_channels=1024, out_channels=1, kernel_size=1, padding=0) 
        ...
        self.simple_value1 = nn.Sequential(
            nn.Conv2d(in_channels=HV_NUMBER+512, out_channels=1024, kernel_size=1, padding=0),
            nn.ReLU(inplace = True),
            nn.Flatten(),
            nn.Linear(163840, 2048),
            nn.Linear(2048, 1024),
            nn.Linear(1024, 512),
            nn.Linear(512, 1)
...
class Dueling_DQN(nn.Module):
    def __init__(self, ACTION_NUMBER, HV_NUMBER):
        ...
        self.simple_value = nn.Sequential(
            nn.Conv2d(in_channels=HV_NUMBER+512, out_channels=1024, kernel_size=1, padding=0),
            nn.ReLU(inplace = True),
            nn.Linear(1024, 1024),
            nn.Linear(1024, 512),
...
class LibraNet_duel(nn.Module):
    def __init__(self, parameters):
        super(LibraNet_duel, self).__init__()  
        #Weights definition
        Action1 = -10
        Action2 = -5
        Action3 = -2
        ...
        self.DQN = Dueling_DQN(parameters['ACTION_NUMBER'], parameters['HV_NUMBER'])
        self.DQN_faze = Dueling_DQN(parameters['ACTION_NUMBER'], parameters['HV_NUMBER'])
...
class LibraNet_duel_simple(nn.Module):
    def __init__(self, parameters):
        super(LibraNet_duel_simple, self).__init__()  
        #Weights definition
        Action1 = -10
        Action2 = -5
        Action3 = -2
        ...
        #Network definition
        self.backbone = VGG16_BackBone()       
        self.DQN = Dueling_DQN_simpleV(parameters['ACTION_NUMBER'], parameters['HV_NUMBER'])
        self.DQN_faze = Dueling_DQN_simpleV(parameters['ACTION_NUMBER'], parameters['HV_NUMBER'])
